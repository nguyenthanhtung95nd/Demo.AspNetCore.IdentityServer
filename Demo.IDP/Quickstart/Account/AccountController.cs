...
namespace IdentityServerHost.Quickstart.UI
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> RegisterAsync(UserRegistrationModel userModel, string returnUrl)
        {
...
string returnUrl)
        ...
        public async Task<IActionResult> Login(LoginInputModel model, string button)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                #endregion Using TestUserService

                #region Using ASP Identity
        ...
        public async Task<IActionResult> Logout(LogoutInputModel model)
        {
            ...
            {
                #region Using TestUser service

                // delete local authentication cookie
                //await HttpContext.SignOutAsync();

                #endregion Using TestUser service
